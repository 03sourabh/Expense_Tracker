...
//    }
	...
	public boolean updateExpenseById(Expense expense) {
	    String query = "UPDATE expenses SET title = ?, amount = ?, category = ?, expense_date = ? WHERE id = ?";
	    ...
	    try (Connection conn = DBConnection.getConnection();
	        ...
	        System.out.println("❌ Error updating expense by ID:");
	        e.printStackTrace();
	        return false;
	    }
	}
