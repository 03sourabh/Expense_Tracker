...
public class MainApp {
	public static void main(String[] args) {
		...
		while (true) {
			...
			System.out.println("7. Edit Expense by ID");
			...
			case 2:
				...
				if (expenses.isEmpty()) {
					...
					for (Expense exp : expenses) {
					    System.out.println("ID      : " + exp.getId());  // ← add this line
			...
			case 7:
			    System.out.print("Enter ID of the expense to edit: ");
			    ...
			    Expense updatedExpense = new Expense(newTitle, newAmount, newCategory, newDate);
			    updatedExpense.setId(editId);  // Important to set the ID for update

			    boolean updated = dao.updateExpenseById(updatedExpense);
			    if (updated) {
			        System.out.println("✅ Expense updated successfully!");
			    } else {
			        System.out.println("⚠️ Update failed. Check if the ID exists.");
			    }
			    break;
